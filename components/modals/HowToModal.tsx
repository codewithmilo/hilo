          ...
          <Grid.Container justify="center">
            ...
            <Grid xs={12} sm={6}>
              <Text size="1.3rem">
                ...
                when either:
                <br />
                - A player sells a token to the game at the current price; or
                <br />- Players buy at least three of a token at the same price.
                <br />
                Before players can sell a token, two must have been bought at
                that price.
                <br />
                Players can enter a queue that will automatically sell for them
                when next possible.
                <br />
                Tokens can only be bought from (minted) or sold to (burned)
                HILO; they are non-transferrable.
                <br />
                <br />
                ...
                the deterministic changes to the prices.
                <br />
